...
After that, open RStudio and launch this code. Make sure you already have installed the ```{devtools}``` package

``` r
devtools::install_github("ShinyFabio/ADViSELipidomics")
```
If R asks you to install packages that requires compilation, click on "No" otherwise the installation progress will take a lot.
